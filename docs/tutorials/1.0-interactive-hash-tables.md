...
algorithm to 'skip over' the **DEL** bucket in the search because it's empty, 
but not occupied, and indeed this is what happens.
...
it maintains will be an exercise we will investigate in 
